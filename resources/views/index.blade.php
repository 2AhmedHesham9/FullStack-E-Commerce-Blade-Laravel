        ...
        <section class="hot-deals container">
            ...
            <div class="row">
                <div
                    ...
                    <h2>Summer Sale</h2>
                    @if($maxSale)
                    <h2 class="fw-bold">Up to {{ $maxSale->maxsale }}% Off</h2>
                    @else
                    <h2 class="fw-bold">Up to 0% Off</h2>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide product-card product-card_style3">
                                    <div class="pc__img-wrapper">
                                        <a href="{{ route('product.details',['slug_product'=>$saleProduct->slug
                                        ]) }}">
                                            <img loading="lazy"
                                                src="{{ asset('uploads/products')}}/{{ $saleProduct->image }}"
                                                width="258" height="313" alt="{{ $saleProduct->name }}" class="pc__img">

                                            @foreach (explode(',',$saleProduct->images) as $image)
                                            <img loading="lazy" src="{{ asset('uploads/products')}}/{{ $image }}"
                                                width="258" height="313" alt="{{ $saleProduct->name }}"
                                    ...
                                    <div class="pc__info position-relative">
                                        <h6 class="pc__title"><a
                                                href="{{ route('product.details',['slug_product'=>$saleProduct->slug]) }}">{{
                                                $saleProduct->name }}</a>
                                        </h6>
                                        <div class="product-card__price d-flex">
                                            <span class="money price text-secondary"> <s> ${{
                                                    $saleProduct->regular_price }}</s> ${{ $saleProduct->sale_price
                                                }}</span>
                                        </div>
                ...
                <div class="col-md-6">
                    <div class="category-banner__item border-radius-10 mb-5">
                        <img loading="lazy" class="h-auto"
                            src="{{ asset('uploads/categories')}}/{{ $randomCategory->image }}" width="690" height="665"
                            alt="{{ $randomCategory->name  }}" />
                        <div class="category-banner__item-mark">
                            Starting at ${{ $randomCategory->products->min('sale_price') }}
                        </div>
                        <div class="category-banner__item-content">
                            <h3 class="mb-0">{{ $randomCategory->name }}</h3>
                            <a href="{{ route('product.details',['slug_product'=>$randomCategory->slug]) }}"
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <a href="{{ route('product.details',['slug_product'=>$featuredProduct->slug
                                        ]) }}  ">
                                <img loading="lazy" src="{{ asset('uploads/products/' . $featuredProduct->image)}}"
                                    width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                            </a>
                        </div>

                        <div class="pc__info position-relative">
                            <h6 class="pc__title"><a href="{{ route('product.details',['slug_product'=>$featuredProduct->slug
                                        ]) }}  ">{{ $featuredProduct->name }}</a></h6>
