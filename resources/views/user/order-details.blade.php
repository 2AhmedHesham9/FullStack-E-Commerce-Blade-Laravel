...
<style>
    ...
    .table> :not(caption)>tr>th {
        text-align: center;
        padding: 0.625rem 1.5rem .25rem !important;
        background-color: rgb(73, 79, 32) !important;
    }
    ...
    <section class="my-account container">
        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        ...
                                        <span class="badge bg-warning fs-7">Orderd</span>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge bg-success fs-7">Approved</span>
                                        @elseif($transaction->status== 'declined')
                                        <span class="badge bg-danger fs-7">Declined</span>
                                        @elseif($transaction->status== 'refunded')
                                        <span class="badge bg-secondary fs-7">Refunded</span>
                                        @else
                                        <span class="badge bg-warning fs-7">Pending</span>
                                        @endif
                ...
                @if($order->status == 'orderd')
                <div class="wg-box mt-7">


                    <form action="{{ route('user.cancle.order') }}" method="POST">
                        @csrf
                        @method('put')
                        <input type="hidden" name="order_id" value="{{ $order->id }}">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button type="button" class="btn btn-danger tf-button w208 cancel-order"    >Cancle Order</button>
                            </div>
                        </div>
